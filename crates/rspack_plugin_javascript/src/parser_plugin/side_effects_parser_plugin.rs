...
use swc_core::{
  ...
  ecma::{
    ast::{
      ArrowExpr, AssignExpr, BlockStmt, BlockStmtOrExpr, Class, ClassMember, Decl, Expr, Function,
      ModuleDecl, ModuleItem, Pat, Program, PropName, SimpleAssignTarget, Stmt, UpdateExpr,
